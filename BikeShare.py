...
def get_filters():
    ...
    Returns:
        (str) city - name of the city to analyze, chicago, washington or new_york_city
        (str) month - name of the month to filter by, January, February, etc. or "all" to apply no month filter
